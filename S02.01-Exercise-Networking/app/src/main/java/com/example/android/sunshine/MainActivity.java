...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        URL weatherUrl = NetworkUtils.buildUrl(SunshinePreferences.getPreferredWeatherLocation(this));
    ...
    public class WeatherQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected void onPostExecute(String s) {
            if(s != null && !s.equals("")){
                ...
                Toast.makeText(MainActivity.this, "Bad Weather, no internet connection. :( ", Toast.LENGTH_SHORT).show();
            }
